            ...
            <div class="row border-bottom py-2">
              ...
              <?php if (current_user_can('administrator')) : ?>
                <div class="col-12 text-secondary">
                  <b>IP:</b> <span x-text="absen.ip_address"></span>
                  <b>DEVICE:</b> <span x-text="absen.device"></span>
                  <b>Lokasi Absen:</b> <a target="_blank" :href="`https://maps.google.com/?q=${absen.lat},${absen.lng}`">
