    ...
    <div x-data="absensiListHandler()">
      ...
      <div class="table-responsive">
        <div class="container mt-4">
          ...
          <template x-for="absen in absensi">
            <div class="row border-bottom py-2">
                ...
                <template x-if="absen.masuk">
                  <span class="d-flex justify-content-start align-items-center">
                    ...
                    <template x-if="absen.masuk.status == 'Terlambat'">
                      <span class="text-danger mx-1" x-bind:title="absen.masuk.status">
                    ...
                    <?php if (current_user_can('administrator')) : ?>
                      <button @click="deleteAbsensi(absen.masuk.id)" class="btn btn-link text-danger btn-sm">
                ...
                <template x-if="absen.pulang">
                  <span>
                    ...
                    <template x-if="absen.pulang.status === 'Pulang awal'">
                      <span class="text-danger mx-1" x-bind:title="absen.pulang.status">
                        <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="currentColor" class="bi bi-exclamation-circle-fill" viewBox="0 0 16 16">
                          <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8 4a.905.905 0 0 0-.9.995l.35 3.507a.552.552 0 0 0 1.1 0l.35-3.507A.905.905 0 0 0 8 4zm.002 6a1 1 0 1 0 0 2 1 1 0 0 0 0-2z"></path>
                        </svg>
                      </span>
                    ...
                    <?php if (current_user_can('administrator')) : ?>
                      <button @click="deleteAbsensi(absen.pulang.id)" class="btn btn-link text-danger btn-sm ms-1">
              ...
              <div class="col-2 text-nowrap px-0">
                <template x-if="absen.masuk">
                  <template x-if="absen.masuk.status == 'Terlambat'">
                    <div class="text-danger small" x-text="'Telat '+absen.masuk.selisih_waktu"></div>
                  </template>
                </template>
                <template x-if="absen.pulang">
                  <template x-if="absen.pulang.status === 'Pulang awal'">
                    <div class="text-warning small" x-text="'Kurang '+absen.pulang.selisih_waktu"></div>
                  </template>
                </template>
              </div>
