    ...
    <div x-data="absensiHandler()" class="card shadow-sm p-4">
      ...
      <div class="row justify-content-center">
        <div class="col-6 mb-2">
          <button @click="absen('masuk')" class="btn btn-primary w-100" x-bind:disabled="sudahAbsen.masuk || loading">
        ...
        <div class="col-6">
          <button @click="absen('pulang')" class="btn btn-danger w-100" x-bind:disabled="sudahAbsen.pulang || loading">
